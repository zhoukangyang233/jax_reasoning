...
class DataProcessConfig(BaseModel):
    source_repo: str = "sapientinc/sudoku-extreme-1k"
    # source_repo: str = "sapientinc/sudoku-extreme"
    output_dir: str = "/kmh-nfs-ssd-us-mount/data/sudoku-extreme-1k"
...
def preprocess_data(config: DataProcessConfig):
    ...
    convert_subset("test_hard", config)
    convert_subset("test_sudoku_bench", config)
